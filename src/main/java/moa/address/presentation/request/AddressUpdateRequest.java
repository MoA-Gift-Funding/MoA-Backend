...
public record AddressUpdateRequest(
        @Schema(description = "배송지명", example = "여의도집") @NotBlank String name,
        @Schema(description = "받는 사람 이름", example = "주노") @NotBlank String recipientName,
        ...
        @Schema(description = "기본 주소지로 설정할지 여부") boolean isDefault
) {
