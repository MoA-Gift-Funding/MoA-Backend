...
public record MemberResponse(
        ...
        @Schema(example = "1") String oauthId,
        @Schema(example = "KAKAO") OauthProvider oauthProvider,
        @Schema(example = "test@gmail.com") @Nullable String email,
        @Schema(example = "짱구") String nickname,
        @Schema(example = "0104") @Nullable String birthday,
        @Schema(example = "2000") @Nullable String birthyear,
        @Schema(example = "https://image.com/imagepath") @Nullable String profileImageUrl,
        @Schema(example = "010-1234-5678") String phoneNumber,
        @Schema(example = "SIGNED_UP") MemberStatus status
) {
